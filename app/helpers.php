...
function getEmailLocation($state) {
  ...
  $return['location'] = '<span style="font-weight: 400;">' . addslashes($data[0]['title']) . '</span><br>'
            ...
            . '<br>'
            . (($data[0]['phone']) ? '<span style="font-weight: 400;">Phone: </span><a href="tel:' . $data[0]['phone'] . '" style="color: #3498db; text-decoration: underline;"><span style="font-weight: 400;">' . $data[0]['phone'] . '</span></a><br>' : '')
            . (($data[0]['email']) ? '<span style="font-weight: 400;">Email: </span><a href="mailto:' . $data[0]['email'] . '" style="color: #3498db; text-decoration: underline;"><span style="font-weight: 400;">' . $data[0]['email'] . '</span></a><br>' : '')
            . '<br>';
